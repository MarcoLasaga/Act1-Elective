...
<head>
  ...
  <link rel="stylesheet" href="/Regis/assets/css/blog.css">
</head>
<body>
  <div class="user-app">
    <!-- Header -->
    <header class="user-header">
      <div class="header-container">
        ...
        <nav class="main-nav">
          ...
          <a href="/Regis/User/blog.php" class="nav-link active">Blog</a>
      ...
      <div class="blog-grid">
        ...
        <article class="blog-card">
          ...
          <div class="blog-content">
            <div class="blog-meta">
              <span class="blog-date"><i class="fas fa-calendar"></i> June 15, 2023</span>
              <span class="blog-category">Recipes</span>
            </div>
            <h2 class="blog-title">10 Easy Dinner Recipes for Busy Weeknights</h2>
            <p class="blog-excerpt">
              Discover quick and delicious dinner ideas that will save you time without sacrificing flavor.
            </p>
            <a href="post.php?id=1" class="read-more">
        ...
        <!-- Blog Post 2 -->
        <article class="blog-card">
          <div class="blog-image"><i class="fas fa-seedling"></i></div>
          <div class="blog-content">
            <div class="blog-meta">
              <span class="blog-date"><i class="fas fa-calendar"></i> June 10, 2023</span>
              <span class="blog-category">Health</span>
            </div>
            <h2 class="blog-title">The Benefits of Eating Seasonal Produce</h2>
            <p class="blog-excerpt">
              Learn why choosing seasonal fruits and vegetables is better for your health and the environment.
            </p>
            <a href="post.php?id=2" class="read-more">
              Read More <i class="fas fa-arrow-right"></i>
            </a>
          </div>
        </article>
        ...
        <!-- Blog Post 3 -->
        <article class="blog-card">
          <div class="blog-image"><i class="fas fa-bread-slice"></i></div>
          <div class="blog-content">
            <div class="blog-meta">
              <span class="blog-date"><i class="fas fa-calendar"></i> June 5, 2023</span>
              <span class="blog-category">Baking</span>
            </div>
            <h2 class="blog-title">Perfect Artisan Bread at Home</h2>
            <p class="blog-excerpt">
              Master the art of homemade bread with our step-by-step guide to creating perfect loaves.
            </p>
            <a href="post.php?id=3" class="read-more">
              Read More <i class="fas fa-arrow-right"></i>
            </a>
          </div>
        </article>
        ...
        <article class="blog-card">
          ...
          <div class="blog-content">
            <div class="blog-meta">
              <span class="blog-date"><i class="fas fa-calendar"></i> May 28, 2023</span>
              <span class="blog-category">Sustainability</span>
            </div>
            <h2 class="blog-title">Reducing Food Waste in Your Kitchen</h2>
            <p class="blog-excerpt">
              Practical tips to minimize food waste and make the most of what you already have.
            </p>
            <a href="post.php?id=4" class="read-more">
              Read More <i class="fas fa-arrow-right"></i>
            </a>
          </div>
        </article>
        ...
        <!-- Blog Post 5 -->
        <article class="blog-card">
          <div class="blog-image"><i class="fas fa-pepper-hot"></i></div>
          <div class="blog-content">
            <div class="blog-meta">
              <span class="blog-date"><i class="fas fa-calendar"></i> May 22, 2023</span>
              <span class="blog-category">Spices</span>
            </div>
            <h2 class="blog-title">The Science Behind Spicy Foods</h2>
            <p class="blog-excerpt">
              Explore how spices affect our taste buds and what makes some foods taste hotter than others.
            </p>
            <a href="post.php?id=5" class="read-more">
              Read More <i class="fas fa-arrow-right"></i>
            </a>
          </div>
        </article>
        ...
        <!-- Blog Post 6 -->
        <article class="blog-card">
          <div class="blog-image"><i class="fas fa-mug-hot"></i></div>
          <div class="blog-content">
            <div class="blog-meta">
            ...
            <p class="blog-excerpt">
              From bean selection to brewing technique, learn how to make exceptional coffee at home.
            </p>
            <a href="post.php?id=6" class="read-more">
              Read More <i class="fas fa-arrow-right"></i>
            </a>
          </div>
        </article>
